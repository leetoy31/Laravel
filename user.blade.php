...
<body>
        ...
        <div class="toggle-track">
            <div class="toggle-thumb">
                <span class="theme-icon" id="themeIcon">
                    <img src="{{ asset('images/icon-light.png') }}" alt="Light" id="themeIconImg" onerror="this.parentElement.innerHTML='🔆'">
                </span>
            </div>
        </div>
    </div>
    ...
    <nav class="top-nav">
        ...
        <div class="user-menu-container">
            <!-- ICON PLACEHOLDER: Add your user menu icon here -->
            <!-- File: public/images/user-menu-icon.png -->
            <div class="user-icon" onclick="toggleUserMenu(event)">
                <img src="{{ asset('images/user-menu-icon.png') }}" alt="User" onerror="this.style.display='none'; this.parentElement.textContent='{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}'">
            </div>
            <div class="user-dropdown" id="userDropdown">
                <!-- ICON PLACEHOLDER: Profile menu icon -->
                <!-- File: public/images/menu-profile-icon.png -->
                <div class="user-dropdown-item">
                    <img src="{{ asset('images/menu-profile-icon.png') }}" alt="Profile" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\'%3E%3Ctext x=\'50%25\' y=\'50%25\' text-anchor=\'middle\' dy=\'.3em\' font-size=\'16\'%3E👤%3C/text%3E%3C/svg%3E'">
                    <span>Profile</span>
                </div>
                <!-- ICON PLACEHOLDER: Settings menu icon -->
                <!-- File: public/images/menu-settings-icon.png -->
                <div class="user-dropdown-item">
                    <img src="{{ asset('images/menu-settings-icon.png') }}" alt="Settings" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\'%3E%3Ctext x=\'50%25\' y=\'50%25\' text-anchor=\'middle\' dy=\'.3em\' font-size=\'16\'%3E⚙️%3C/text%3E%3C/svg%3E'">
                    <span>Settings</span>
                </div>
                <form action="{{ route('logout') }}" method="POST" style="margin: 0;">
                    @csrf
                    <!-- ICON PLACEHOLDER: Logout menu icon -->
                    <!-- File: public/images/menu-logout-icon.png -->
                    <div class="user-dropdown-item logout" onclick="this.closest('form').submit()">
                        <img src="{{ asset('images/menu-logout-icon.png') }}" alt="Logout" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=\'http://www.w3.org/2000/svg\' viewBox=\'0 0 24 24\'%3E%3Ctext x=\'50%25\' y=\'50%25\' text-anchor=\'middle\' dy=\'.3em\' font-size=\'16\'%3E🚪%3C/text%3E%3C/svg%3E'">
                        <span>Logout</span>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        function toggleTheme() {
            ...
            // OPTION 1: Use Custom Images (Recommended)
            // Place your icon images in public/images/ folder
            // icon-light.png for light mode
            // icon-dark.png for dark mode
            if (newTheme === 'dark') {
                iconContainer.innerHTML = '<img src="{{ asset("images/icon-dark.png") }}" alt="Dark" onerror="this.parentElement.innerHTML=\'🌙\'">';
            } else {
                iconContainer.innerHTML = '<img src="{{ asset("images/icon-light.png") }}" alt="Light" onerror="this.parentElement.innerHTML=\'☀️\'">';
            }
            
            // OPTION 2: Use Emojis (Fallback)
            // Uncomment below and comment out Option 1 if you want to use emojis
            // iconContainer.textContent = newTheme === 'dark' ? '🌙' : '☀️';
        ...
        window.addEventListener('DOMContentLoaded', () => {
            ...
            // OPTION 2: Use Emojis (Fallback)
            // Uncomment below and comment out Option 1 if you want to use emojis
            // iconContainer.textContent = savedTheme === 'dark' ? '🌙' : '☀️';
