...
<body>
    ...
    <nav class="top-nav">
        ...
        <div class="user-menu-container">
            <!-- ICON PLACEHOLDER: Add your admin user icon here -->
            <!-- File: public/images/admin-user-menu-icon.png -->
            <div class="user-icon" onclick="toggleUserMenu(event)">
                <img src="{{ asset('images/admin-user-menu-icon.png') }}" alt="Admin" onerror="this.style.display='none'; this.parentElement.textContent='{{ strtoupper(substr(Auth::user()->name, 0, 1)) }}'">
            </div>
